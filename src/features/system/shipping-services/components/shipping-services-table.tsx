...
/**
 * Props for PaymentTypesTable component
 */
interface ShippingServicesTableProps<TData, TValue> {
 ...
 */
export function ShippingServicesTable<TData, TValue>({
  data,
  totalItems,
  columns
}: ShippingServicesTableProps<TData, TValue>) {
 ...
 */
export function ShippingServicesTableSkeleton() {
