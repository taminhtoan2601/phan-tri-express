 ...
 */
interface CommodityTypesTableProps<TData, TValue> {
  data: CommodityType[];
  totalItems: number;
 ...
 */
export function CommodityTypesTable<TData, TValue>({
  data,
  totalItems,
  columns
}: CommodityTypesTableProps<TData, TValue>) {
 ...
 */
export function CommodityTypesTableSkeleton() {
