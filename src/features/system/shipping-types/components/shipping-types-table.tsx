...
/**
 * Props for ShippingTypesTable component
 */
interface ShippingTypesTableProps<TData, TValue> {
  data: ShippingType[];
  totalItems: number;
 ...
 */
export function ShippingTypesTable<TData, TValue>({
  data,
  totalItems,
  columns
}: ShippingTypesTableProps<TData, TValue>) {
 ...
 */
export function ShippingTypesTableSkeleton() {
