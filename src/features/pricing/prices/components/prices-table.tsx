...
interface PricesTableProps<TData, TValue> {
  data: TData[];
  totalItems: number;
...
/**
 * Advanced data table for displaying prices with filtering, sorting, and pagination
 */
export function PricesTable<TData, TValue>({
  data,
  totalItems,
  columns
}: PricesTableProps<TData, TValue>) {
