 ...
 */
interface InsurancePackagesTableProps<TData, TValue> {
 ...
 */
export function InsurancePackagesTable<TData, TValue>({
  data,
  totalItems,
  columns
}: InsurancePackagesTableProps<TData, TValue>) {
 ...
 */
export function InsurancePackagesTableSkeleton() {
